package com.rifdahalf.aplikasirestoran.activities
...
import com.rifdahalf.aplikasirestoran.adapter.HighlightsAdapter
import com.rifdahalf.aplikasirestoran.adapter.ReviewAdapter
import com.rifdahalf.aplikasirestoran.model.ModelHighlights
import com.rifdahalf.aplikasirestoran.model.ModelMain
import com.rifdahalf.aplikasirestoran.model.ModelReview
import com.rifdahalf.aplikasirestoran.networking.ApiEndpoint
...
class DetailRestoActivity : AppCompatActivity() {
    ...
    private fun getDetailResto() {
        ...
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.DetailRestaurant + IdResto)
            .addHeaders("user-key", "f12f08b45ef7432e4aa68d1b9c049efd")
